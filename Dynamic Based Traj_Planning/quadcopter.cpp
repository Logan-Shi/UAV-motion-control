...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    ocp1.subjectTo(AT_START, x1 == 3.00000000000000000000e+00);
    ...
    ocp1.subjectTo(AT_START, x5 == 2.50000000000000000000e+00);
    ...
    ocp1.subjectTo(AT_START, x11 == 3.92699081698724139500e-01);
    ...
    ocp1.subjectTo(AT_END, x3 == 0.00000000000000000000e+00);
    ocp1.subjectTo(AT_END, x4 == 0.00000000000000000000e+00);
    ocp1.subjectTo(AT_END, x5 == 2.00000000000000000000e+00);
    ...
    ocp1.subjectTo(AT_END, x11 == 5.23598775598298815659e-01);
