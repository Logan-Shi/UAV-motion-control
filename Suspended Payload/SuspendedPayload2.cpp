...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    acadodata_f1 << dot(x12) == ((-1.02821494102228050416e+00)*x10+5.24246395806028830933e-01*x24);
    acadodata_f1 << dot(x13) == (1.02821494102228050416e+00*x11-5.24246395806028830933e-01*x25);
    acadodata_f1 << dot(x14) == 1/1.50000000000000000000e+00*x23;
    acadodata_f1 << dot(x15) == 1/8.10000000000000025535e-02*x24;
    acadodata_f1 << dot(x16) == 1/8.10000000000000025535e-02*x25;
    acadodata_f1 << dot(x17) == 1/1.41999999999999987343e-01*x26;
    acadodata_f1 << dot(x18) == ((-5.14107470511140185465e+00)*x10-3.40760157273918729004e+00*x24);
    acadodata_f1 << dot(x19) == ((-5.14107470511140185465e+00)*x11+3.40760157273918729004e+00*x25);
    acadodata_f1 << dot(x20) == 1/1.50000000000000000000e+00*x23;
    acadodata_f1 << dot(x21) == (1.50000000000000000000e+00/3.81500000000000005773e-01*x24+7.71161205766710367016e+00*x10);
    acadodata_f1 << dot(x22) == (1.50000000000000000000e+00/3.81500000000000005773e-01*x25+7.71161205766710367016e+00*x11);
    ...
    ocp1.subjectTo(AT_START, x23 == 1.47098999999999993094e+01);
    ocp1.subjectTo(AT_START, x24 == 0.00000000000000000000e+00);
    ocp1.subjectTo(AT_START, x25 == 0.00000000000000000000e+00);
    ocp1.subjectTo(AT_START, x26 == 0.00000000000000000000e+00);
    ...
    ocp1.subjectTo(AT_END, x5 == 0.00000000000000000000e+00);
    ocp1.subjectTo(AT_END, x6 == 7.85398163397448278999e-01);
    ocp1.subjectTo(AT_END, x7 == 4.00000000000000000000e+00);
    ocp1.subjectTo(AT_END, x8 == 5.00000000000000000000e+00);
    ocp1.subjectTo(AT_END, x9 == 5.00000000000000000000e+00);
    ocp1.subjectTo(AT_END, x10 == 0.00000000000000000000e+00);
    ocp1.subjectTo(AT_END, x11 == 0.00000000000000000000e+00);
    ocp1.subjectTo(AT_END, x12 == 0.00000000000000000000e+00);
    ocp1.subjectTo(AT_END, x13 == 0.00000000000000000000e+00);
    ocp1.subjectTo(AT_END, x14 == 0.00000000000000000000e+00);
    ocp1.subjectTo(AT_END, x15 == 0.00000000000000000000e+00);
    ocp1.subjectTo(AT_END, x16 == 0.00000000000000000000e+00);
    ocp1.subjectTo(AT_END, x17 == 0.00000000000000000000e+00);
    ocp1.subjectTo(AT_END, x18 == 0.00000000000000000000e+00);
    ocp1.subjectTo(AT_END, x19 == 0.00000000000000000000e+00);
    ocp1.subjectTo(AT_END, x20 == 0.00000000000000000000e+00);
    ocp1.subjectTo(AT_END, x21 == 0.00000000000000000000e+00);
    ocp1.subjectTo(AT_END, x22 == 0.00000000000000000000e+00);
    ocp1.subjectTo(AT_END, x23 == 1.47098999999999993094e+01);
    ocp1.subjectTo(AT_END, x24 == 0.00000000000000000000e+00);
    ocp1.subjectTo(AT_END, x25 == 0.00000000000000000000e+00);
    ocp1.subjectTo(AT_END, x26 == 0.00000000000000000000e+00);
