...
acadoSet('problemname', 'SuspendedPayload');
...
% f.add(dot(s) == v);
    ...
    f.add(dot(x12)==-g*L^2*mp^2/den1*x10+L*mp/den1*kb*(x24^2-x26^2));
    f.add(dot(x13)==g*L^2*mp^2/den2*x11-L*mp/den1*kb*(x25^2-x23^2));
    f.add(dot(x14)==kb*(x23^2+x24^2+x25^2+x26^2)/(m+mp));
    f.add(dot(x15)==kb*(x24^2-x26^2)/Ix);
    f.add(dot(x16)==kb*(x25^2-x23^2)/Iy);
    f.add(dot(x17)==kt*(x23^2-x24^2+x25^2-x26^2)/Iz);
    f.add(dot(x18)==-g*L^2*mp/den2*x10-L*m/den1*kb*(x24^2-x26^2));
    f.add(dot(x19)==-g*L^2*mp/den1*x11+L*m/den2*kb*(x25^2-x23^2));
    f.add(dot(x20)==kb*(x23^2+x24^2+x25^2+x26^2)/(m+mp));
    f.add(dot(x21)==g*L^2*mp*(mp+m)/den1*x10+kb*(x24^2-x26^2)*(m+mp)/den1);
    f.add(dot(x22)==g*L^2*mp*(mp+m)/den2*x11+kb*(x25^2-x23^2)*(m+mp)/den2);
...
% ocp.minimizeLagrangeTerm(x7^2+x8^2+x9^2+x1^2+x2^2+x3^2);
% ocp.minimizeLagrangeTerm(c1+c2*x23+c3*x23^2+c4*x23^3+c5*x23^4 ...
%       +c1+c2*x24+c3*x24^2+c4*x24^3+c5*x24^4 ...
%       +c1+c2*x25+c3*x25^2+c4*x25^3+c5*x25^4 ...
%       +c1+c2*x26+c3*x26^2+c4*x26^3+c5*x26^4 ...
...
ocp.subjectTo('AT_START', x23 == omega_h);
ocp.subjectTo('AT_START', x24 == omega_h);
ocp.subjectTo('AT_START', x25 == omega_h);
ocp.subjectTo('AT_START', x26 == omega_h);
...
% ocp.subjectTo('AT_END', x23 == omega_h);
% ocp.subjectTo('AT_END', x24 == omega_h);
% ocp.subjectTo('AT_END', x25 == omega_h);
% ocp.subjectTo('AT_END', x26 == omega_h);


ocp.subjectTo( 0.01 <= x23 <= omega_max );
ocp.subjectTo( 0.01 <= x24 <= omega_max );
ocp.subjectTo( 0.01 <= x25 <= omega_max );
ocp.subjectTo( 0.01 <= x26 <= omega_max );

% ocp.subjectTo( 0.001 <= x10 <= pi/12 );
% ocp.subjectTo( 0.001 <= x11 <= pi/12 );
...
out = SuspendedPayload_RUN(); % Run the test.