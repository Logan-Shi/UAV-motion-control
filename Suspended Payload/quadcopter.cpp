...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    acadodata_f1 << dot(theta) == thetadot;
    acadodata_f1 << dot(thetadot) == ((-cos(x11)*x7+sin(x11)*x9)*(pow(x13,2.00000000000000000000e+00)+pow(x14,2.00000000000000000000e+00)+pow(x15,2.00000000000000000000e+00)+pow(x16,2.00000000000000000000e+00))*7.36629045687013682338e-07+(cos(x11)*x9+sin(x11)*x7)*(pow(x13,2.00000000000000000000e+00)+pow(x14,2.00000000000000000000e+00)+pow(x15,2.00000000000000000000e+00)+pow(x16,2.00000000000000000000e+00))*2.20988713706104104701e-06);
    ...
    ocp1.subjectTo(AT_START, thetadot == 0.00000000000000000000e+00);
