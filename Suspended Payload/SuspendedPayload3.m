...
% f.add(dot(s) == v);
    ...
    f.add(dot(x13)==x14); %thetaL
    f.add(dot(x14)==-kb/m*(x13^2+x14^2+x15^2+x16^2)*sin(x13)/L);
%     f.add(dot(x15)==x16);  %phiL
%     f.add(dot(x16)==(kb/m*(x7*sin(x11)+cos(x11)*x9)*(x13^2+x14^2+x15^2+x16^2)*sin(x15)-kb/m*(x9*sin(x11)-cos(x11)*x7)*(x13^2+x14^2+x15^2+x16^2)*cos(x15)+2*x12*L*x14*cos(x13)-L*x15*x16*cos(x14)));
...
ocp.minimizeLagrangeTerm(x14^2);
...
ocp.subjectTo('AT_START', x13 == 0.1);
ocp.subjectTo('AT_START', x14 == 0.0);
% ocp.subjectTo('AT_START', x15 == 0.0);
% ocp.subjectTo('AT_START', x16 == 0.0);


ocp.subjectTo('AT_START', x17 == omega_h);
ocp.subjectTo('AT_START', x18 == omega_h);
ocp.subjectTo('AT_START', x19 == omega_h);
ocp.subjectTo('AT_START', x20 == omega_h);
...
% ocp.subjectTo('AT_END', x17 == omega_h);
% ocp.subjectTo('AT_END', x18 == omega_h);
% ocp.subjectTo('AT_END', x19 == omega_h);
% ocp.subjectTo('AT_END', x20 == omega_h);




ocp.subjectTo( 0.01 <= x17 <= omega_max );
ocp.subjectTo( 0.01 <= x18 <= omega_max );
ocp.subjectTo( 0.01 <= x19 <= omega_max );
ocp.subjectTo( 0.01 <= x20 <= omega_max );
