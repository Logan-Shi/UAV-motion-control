function [p,v,a,J]=min_snap_simple_fcn(waypts,v0,a0,v1,a1,T,tt,r)
    ...
    if nargin > 7
        polys_x = minimum_snap_single_axis_corridor(waypts(1,:),ts,n_order,v0(1),a0(1),v1(1),a1(1),r);
        polys_y = minimum_snap_single_axis_corridor(waypts(2,:),ts,n_order,v0(2),a0(2),v1(2),a1(2),r);
        polys_z = minimum_snap_single_axis_corridor(waypts(3,:),ts,n_order,v0(3),a0(3),v1(3),a1(3),r);
    else
