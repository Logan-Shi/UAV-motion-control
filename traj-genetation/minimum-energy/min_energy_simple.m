function min_energy_simple(waypts,v0,a0,v1,a1,T,h)
    ...
    polys_z = minimum_snap_single_axis_z_simple(waypts(3,:),ts,n_order,v0(3),a0(3),v1(3),a1(3));
...
function polys = minimum_snap_single_axis_z_simple(waypts,ts,n_order,v0,a0,ve,ae)
p0 = waypts(1);
pe = waypts(end);
...
f_all = [];
for i=1:n_poly
    f_all = [f_all, compute_f(n_order,ts(i),ts(i+1))];
end
...
p = quadprog(Q_all,f_all,Aieq,bieq,Aeq,beq);
